 ...
 */
public class OpenStackMiddleware implements CloudMiddleware {
    ...
    public OpenStackMiddleware() {
		Configuration configuration = Clurge.INSTANCE.getConfiguration().subset(CONFIG_OPENSTACK_SUBSET_PREFIX);

		OpenStackCredentials credentials = new OpenStackCredentials(configuration);
        ...
        this.securityGroups = configuration.getStringArray(CONFIG_SECURITY_GROUPS);
