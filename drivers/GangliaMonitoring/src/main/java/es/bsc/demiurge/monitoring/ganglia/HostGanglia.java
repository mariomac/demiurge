...
public class HostGanglia extends Host {
	...
	public es.bsc.demiurge.monitoring.ganglia.Host gangliaHost;
	...
	private void setGangliaHost() {
		...
		for (Cluster cluster : clusterList) {
			List<es.bsc.demiurge.monitoring.ganglia.Host> hosts = cluster.getHosts();
			for (es.bsc.demiurge.monitoring.ganglia.Host host: hosts) {
