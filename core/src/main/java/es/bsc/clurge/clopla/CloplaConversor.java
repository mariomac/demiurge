...
public class CloplaConversor {
     ...
     */
    public static List<Vm> getCloplaVms(List<VirtualMachine> vms,
												   List<VirtualMachine> vmsToDeploy,
     ...
     */
    public static List<Host> getCloplaHosts(List<PhysicalHost> hosts) {
     ...
     */
    public static List<VirtualMachine> cloplaVmsToVmmType(List<CloplaVmModel> vms) {
    ...
    private static CloplaVmModel getCloplaVmToDeploy(Long id, VirtualMachine vm) {
     ...
     */
    private static Host findCloplaHost(List<Host> cloplaHosts,
									   String hostname) {
        for (Host cloplaHost: cloplaHosts) {
	...
	public static PhysicalHost cloplaHostsToVmmType(Host host) {
