...
public class CloplaHostFactory {
    ...
    private static final Map<String, es.bsc.demiurge.core.clopla.domain.Host> cloplaHosts = new HashMap<>();
    ...
    public static es.bsc.demiurge.core.clopla.domain.Host getCloplaHost(es.bsc.demiurge.core.monitoring.hosts.Host host) {
        ...
        result = new es.bsc.demiurge.core.clopla.domain.Host(cloplaHostId, host.getHostname(), host.getTotalCpus(),
                host.getTotalMemoryMb(), host.getTotalDiskGb(), !host.isOn(), host.getIdlePower(), host.getMaxPower(), host.getType());
        ++cloplaHostId;
